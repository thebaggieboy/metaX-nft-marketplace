      ...
      >
        ...
        >
          <Flex justify="between" align="start" css={{ mb: '$3' }}>
            <Text style="h4" as="h4">
              <p style={{ fontFamily: "Poppins, Sans-serif",}}>Trending</p>
            </Text>
            {!isSmallDevice && (
              <Flex
                align="center"
          ...
          <TabsList css={{ mb: 24, mt: 0, borderBottom: 'none',  fontFamily: "Poppins, Sans-serif", }}>
          ...
          {isSmallDevice && (
            ...
            >
              <Flex align="center" css={{ gap: '$4',  fontFamily: "Poppins, Sans-serif", }}>
                {tab === 'collections' ? (
                  <CollectionsTimeDropdown
                    compact={isSmallDevice && isMounted}
                    option={sortByTime}
        ...
        <Box css={{ my: '$5',  fontFamily: "Poppins, Sans-serif", }}>
